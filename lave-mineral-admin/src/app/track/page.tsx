...
export default function AdminTrackPage() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-[#f0f6ff] via-white to-[#e6f0ff] px-6 py-16">
      ...
      >
        <div className="mb-4 inline-flex items-center gap-2 rounded-full border border-[#0066FF]/15 bg-[#0066FF]/8 px-4 py-2 text-sm font-semibold text-[#0066FF]">
          <FaUserShield />
        ...
        <p className="mt-3 tracking-wide text-gray-500">
          Admin order lookup • Live updates • Bulk tracking support
        </p>
      </motion.div>
