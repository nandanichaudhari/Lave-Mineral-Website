          ...
          <AnimatePresence>
            {cart.map((item) => (
              ...
              >
                ...
                <div className="mt-4 flex items-center gap-4 px-4 py-2 rounded-full bg-gray-100 shadow-inner">
                  <button
                    onClick={(e) => {
                      e.stopPropagation();
                      decreaseQty(item);
          ...
          >
            ...
            >
              ...
              <Link
                ...
                onClick={() => setSelectedProduct(null)}
                className="mt-6 w-full bg-[#4c6ef5] hover:bg-[#3b5bdb] text-white font-semibold py-2 rounded-xl text-center transition-all"
              >
                Buy Now
              </Link>
            </motion.div>
