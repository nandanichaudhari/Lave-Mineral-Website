...
export default function AdminCartPage() {
  ...
  const fetchProfile = async () => {
    try {
      ...
      const data = await res.json();
      const adminData = data?.admin || data?.profile || data || null;
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-[#eef6ff] via-white to-[#f7fbff] pt-[110px] xl:pt-[92px] text-slate-800">
          ...
          <div className="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
            <div>
              ...
              <p className="mt-2 max-w-2xl text-sm leading-6 text-slate-600 md:text-base">
                Manage combined bottle quantities and create one bulk order with
                the same smooth flow as the user side.
              </p>
            </div>
          ...
          <div className="flex min-h-[55vh] items-center justify-center">
            <div className="w-full max-w-2xl rounded-[30px] border border-white/60 bg-white/80 px-6 py-12 text-center shadow-[0_20px_60px_rgba(0,102,255,0.08)] backdrop-blur-xl">
              ...
              <p className="mx-auto mt-3 max-w-md text-slate-600">
                Add products and manage one combined bulk order from the admin
                panel.
              </p>
            ...
            <div className="h-fit xl:sticky xl:top-6">
              <div className="overflow-hidden rounded-[30px] border border-white/70 bg-white/90 shadow-[0_20px_60px_rgba(0,102,255,0.08)] backdrop-blur-xl">
                <div className="border-b border-slate-100 bg-gradient-to-r from-[#0066FF] to-[#00b7ff] p-5 text-white">
                  <h3 className="text-xl font-bold">Admin Order Summary</h3>
                  <p className="mt-1 text-sm text-white/90">
                    Bulk order checkout for all admin cart products
                  </p>
                </div>
                ...
                <div className="space-y-5 p-5">
                  ...
                  >
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        >
                          {minimumReached
                            ? "Admin cart meets the minimum 50 boxes rule."
                  ...
                  <p className="text-center text-xs leading-5 text-slate-500">
                    This admin checkout is designed for combined bottle ordering.
                  </p>
                </div>
              </div>
            </div>
