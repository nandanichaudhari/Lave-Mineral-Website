  ...
  return (
    <main className="min-h-screen flex items-center justify-center px-6 bg-white">
      <motion.div
        ...
        className="w-full max-w-xl relative overflow-hidden rounded-3xl p-8 bg-white shadow-lg"
      >
        <div className="relative z-10">
          ...
          <div className="flex items-center gap-3 p-4 mb-6 rounded-xl text-sm text-[#d6336c] bg-white shadow-md">
            <FaExclamationTriangle />
          ...
          <div className="flex items-center gap-3 mb-5">
            ...
            <input
              ...
              className="w-full p-3 rounded-xl bg-white shadow-md focus:outline-none focus:ring-2 focus:ring-[#4c6ef5] transition"
            />
          </div>
          ...
          <Link
            href="/"
            className="block w-full mt-4 py-3 rounded-xl text-center font-medium text-[#4c6ef5] bg-white shadow-md hover:scale-[1.02] transition-all"
          >
            ← Back to Home
          </Link>
        </div>
