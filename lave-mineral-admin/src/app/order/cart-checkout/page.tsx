...
export default function AdminCartCheckoutPage() {
  ...
  const [bulkOrderResult, setBulkOrderResult] =
    useState<BulkOrderSuccess | null>(null);
  ...
  useEffect(() => {
    try {
      ...
      console.error("Admin checkout data load error:", err);
  ...
  const clearCartAfterSuccess = async () => {
    try {
      ...
      console.error("Admin cart clear error:", err);
    }
  };
  ...
  if (loading) {
    return (
      <main className="min-h-screen bg-[#f7f8fa] pt-[110px] xl:pt-[92px]">
        <div className="mx-auto flex min-h-[70vh] max-w-5xl items-center justify-center px-4 py-10">
          <div className="rounded-3xl border border-slate-200 bg-white px-8 py-12 text-center shadow-sm">
            ...
            <h2 className="text-xl font-bold text-slate-900">
              Loading admin checkout...
            </h2>
            <p className="mt-2 text-sm text-slate-600">
              Preparing your admin order review page.
            </p>
          </div>
        </div>
      </main>
          ...
          >
            <div className="border-b border-slate-200 bg-emerald-50 px-6 py-8">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <div className="mb-2 inline-flex items-center gap-2 rounded-full border border-[#0066FF]/15 bg-[#0066FF]/10 px-3 py-1 text-xs font-semibold text-[#0066FF]">
                    <FaShieldAlt />
                    Admin Bulk Checkout
                  </div>
        ...
        <div className="mx-auto flex min-h-[70vh] max-w-4xl items-center justify-center px-4 py-10">
          <div className="w-full rounded-3xl border border-slate-200 bg-white px-8 py-14 text-center shadow-sm">
            ...
            <p className="mx-auto mt-3 max-w-md text-slate-600">
              Your admin checkout session is empty. Please add products to cart
              first.
            </p>
            <Link
              href="/cart"
  ...
  return (
    <main className="min-h-screen bg-[#f7f8fa] pt-[110px] xl:pt-[92px] text-slate-800">
          ...
          <div className="space-y-6">
              ...
              <div className="flex flex-col gap-4 p-6 md:flex-row md:items-start md:justify-between">
                <div>
                  ...
                  <h2 className="text-[1.7rem] font-bold text-slate-900">
                    Delivering to {formData.name || "Admin Customer"}
                  </h2>
            ...
            >
              <div className="border-b border-slate-200 px-6 py-5">
                ...
                <p className="mt-1 text-sm text-slate-600">
                  Admin can review, update, and use multiple phone numbers and
                  addresses before placing the combined bulk order.
                </p>
              </div>
            ...
            <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
              ...
              <div className="mt-5 border-t border-slate-200 pt-5">
                ...
                <p className="mt-4 text-xs leading-5 text-slate-500">
                  This admin checkout sends one combined order with one main
                  order ID and separate tracking IDs for each product item.
                </p>
