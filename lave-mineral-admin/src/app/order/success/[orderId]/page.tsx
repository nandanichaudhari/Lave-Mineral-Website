  ...
  return (
    <main className="min-h-screen flex items-center justify-center px-4 sm:px-6 bg-white relative overflow-hidden">
      <motion.div
        ...
        className="w-full max-w-xl rounded-3xl p-6 sm:p-10 text-center bg-white shadow-lg"
      >
        <motion.div
          initial={{ scale: 0 }}
          animate={{ scale: 1 }}
        ...
        <p className="text-[#718096] text-sm sm:text-base mb-6">
          Your order request has been received. We’ll process it shortly and keep you updated.
        </p>

        <div className="rounded-2xl p-5 text-left bg-white shadow-md">
          <div className="flex justify-between items-center mb-4 flex-wrap gap-2">
            ...
            <button
              ...
              disabled={!orderId}
              type="button"
              className="flex items-center gap-1 text-xs px-3 py-1 rounded-lg bg-white text-[#4c6ef5] shadow-sm hover:scale-105 transition disabled:opacity-50 disabled:cursor-not-allowed"
            >
              <FaCopy />
              {copied ? "Copied" : "Copy"}
            </button>
        ...
        <div className="mt-8 grid grid-cols-1 sm:grid-cols-3 gap-3">
          ...
          <Link
            href="/update"
            className="py-3 rounded-xl text-sm font-medium bg-white text-[#4c6ef5] shadow-md hover:scale-[1.03] transition-all text-center"
          >
            ✏️ Update
          </Link>
          ...
          <Link
            href="/cancel"
            className="py-3 rounded-xl text-sm font-medium bg-white text-[#868e96] shadow-md hover:scale-[1.03] transition-all text-center"
          >
            ❌ Cancel
          </Link>
        </div>
