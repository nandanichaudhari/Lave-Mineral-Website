...
export default function Home() {
  return (
    <main className="m-0 w-full overflow-x-hidden bg-white p-0">
      {/* Hero Section */}
      <section
      ...
      >
        ...
        <div className="relative z-10 mx-auto flex w-full max-w-4xl flex-col items-center justify-center py-20">
          <Image
      ...
      {/* Final CTA */}
      <section
        className="relative flex min-h-[400px] w-full items-center justify-center overflow-hidden px-6 py-16 text-center text-white"
        style={{
